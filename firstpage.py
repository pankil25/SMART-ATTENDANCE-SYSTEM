...
def attend():
    sub = input("Enter sub name to view attendance : ")
    dat = input("Enter date[yyyy-mm-dd] on which want to view attendance : ")
    os.startfile("C:/Users/panki/Desktop/attendance/attendance_sheets/"+sub+dat+'.xlsx')

#stting title for the window
root.title("AUTOMATIC ATTENDANCE MANAGEMENT USING ACE RECOGNITION")
